...
public class RelatedGameTest
{
	...
	{
		new RelatedGame( null, "company", 0 );
	}

	@Test
	public void testEqualityAndHashcode()
	{
		RelatedGame relatedGame1a = new RelatedGame( "gameName1", "company1", 1 );
		RelatedGame relatedGame1b = new RelatedGame( "gameName1", "company2", 1 );
		RelatedGame relatedGame2 = new RelatedGame( "gameName1", "company2", 2 );
		RelatedGame relatedGame3 = new RelatedGame( "gameName2", "company1", 3 );
	...
	{
		RelatedGame relatedGame = new RelatedGame( "gameName", "company", 1 );
