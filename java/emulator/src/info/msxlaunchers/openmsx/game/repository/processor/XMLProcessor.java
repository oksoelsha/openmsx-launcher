...
public interface XMLProcessor
{
	 ...
	 * all games in a given softwaredb XML file
	 * 
	 * @param xmlFile Full path to softwaredb XML file
	 * @return Unmodifiable Map of hash codes to RepositoryGame objects
	 * @throws IOException if given XML file cannot be accessed
	 */
	Map<String,RepositoryGame> getRepositoryInfo( String xmlFile ) throws IOException;
	 ...
	 * @throws IOException if given XML file cannot be accessed
	 */
	Set<String> getDumpCodes( String xmlFile, String code ) throws IOException;
	 ...
	 * @throws IOException if given XML file cannot be accessed
	 */
	RepositoryGame getGameInfo( String xmlFile, String code ) throws IOException;
}
