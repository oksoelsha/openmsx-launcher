...
/**
 * Class to contain result of <code>GetDatabasesAction</code> operation
 * 
 * @since v1.4
 * @author Sam Elsharif
 *
 */
final class GetDatabasesResponse implements DatabaseResponse<Set<String>>
{
	private final Set<String> databases;

	GetDatabasesResponse( Set<String> databases )
	{
