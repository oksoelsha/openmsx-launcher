...
/**
 * Class to contain result of <code>GetGamesAction</code> operation
 * 
 * @since v1.4
 * @author Sam Elsharif
 *
 */
final class GetGamesResponse implements DatabaseResponse<Set<Game>>
{
	private final Set<Game> games;

	GetGamesResponse( Set<Game> games )
	{
		this.games = games;
	}
