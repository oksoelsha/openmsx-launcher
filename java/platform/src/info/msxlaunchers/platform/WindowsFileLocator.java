...
/**
 * Windows implementation of <code>FileLocator</code> that brings up 'explorer'
 * 
 * @since v1.1
 * @author Sam Elsharif
 *
 */
final class WindowsFileLocator implements FileLocator
{
	private final ArgumentsBuilder argumentsBuilder;

	@Inject
	WindowsFileLocator( ArgumentsBuilder argumentsBuilder )
	{
	...
	{
		argumentsBuilder.append( "explorer.exe" );
		argumentsBuilder.appendIfValueDefined( "/select,", filePath );
