...
/**
 * Implementation of <code>PlatformViewProperties</code> for platforms other than the ones supported
 * 
 * @since v1.2
 * @author Sam Elsharif
 *
 */
final class OtherPlatformViewProperties implements PlatformViewProperties
{
	/* (non-Javadoc)
