...
/**
 * Windows implementation of <code>PlatformViewProperties</code>
 * 
 * @since v1.2
 * @author Sam Elsharif
 *
 */
final class WindowsViewProperties implements PlatformViewProperties
{
	private static final File OPENMSX_PATH = new File("C:\\Program Files\\openMSX");
	...
	{
		if(OPENMSX_PATH.exists())
		{
			return OPENMSX_PATH.getAbsolutePath();
		}
		else
		{
			return null;
